...
public static class GetAllRoleRequest
{
    public record Query(
    ...
    public class Handler
        ...
        : GetAllRequest.Handler<Query, Domain.Models.Identity.Role, RoleDto, IMultiTenantRepository<Domain.Models.Identity.Role>>(repository)
    {
    }
}